    ...
    def get(self):
        ...
        if decorator.has_credentials():
            ...
            if len(tuberuser_sub_channels) > 2:
                ...
                feed, number_of_vids = create_feed.feed_cat(tuberuser_sub_channels, category, page)
                ...
                template = template_env.get_template('/www/category.html')
...
routes = [('/category', Category),  (decorator.callback_path, decorator.callback_handler())]
